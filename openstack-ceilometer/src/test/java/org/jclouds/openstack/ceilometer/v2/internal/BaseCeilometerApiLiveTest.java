 ...
 */
package org.jclouds.openstack.ceilometer.v2.internal;
...
/**
 * Tests behavior of {@link CeilometerApi}.
 *
 */
@Test(groups = "live")
public class BaseCeilometerApiLiveTest extends BaseApiLiveTest<CeilometerApi> {

   protected Set<String> regions;

   public BaseCeilometerApiLiveTest() {
      provider = "openstack-ceilometer";
   }
